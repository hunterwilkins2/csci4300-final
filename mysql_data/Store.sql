...
CREATE TABLE `Products` (
  ...
  `pgender` enum('Men','Women') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `ptype` enum('Running','Basketball','Skateboard') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
